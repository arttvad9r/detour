...
import (
	...
	"github.com/metacubex/bart/internal/value"
)
...
func (n *_NODE_TYPE[V]) AllChildren() (_ func(yield func(uint8, any) bool))              { return }
func (n *_NODE_TYPE[V]) AllIndices() (_ func(yield func(uint8, V) bool))                 { return }
...
func (t *_TABLE_TYPE[V]) Supernets(pfx netip.Prefix) func(yield func(netip.Prefix, V) bool) {
...
// The iteration can be stopped early by breaking from the range loop.
// Returns an empty iterator if the prefix is invalid.
func (t *_TABLE_TYPE[V]) Subnets(pfx netip.Prefix) func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
		if !pfx.IsValid() {
			return
		}
...
func (t *_TABLE_TYPE[V]) All() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
...
func (t *_TABLE_TYPE[V]) All4() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
...
func (t *_TABLE_TYPE[V]) All6() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
...
func (t *_TABLE_TYPE[V]) AllSorted() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
...
func (t *_TABLE_TYPE[V]) AllSorted4() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
		_ = t.root4.AllRecSorted(stridePath{}, 0, true, yield)
	}
}
...
func (t *_TABLE_TYPE[V]) AllSorted6() func(yield func(netip.Prefix, V) bool) {
	return func(yield func(netip.Prefix, V) bool) {
