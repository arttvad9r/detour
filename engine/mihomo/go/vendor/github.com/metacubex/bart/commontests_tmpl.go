...
func (*_TABLE_TYPE[V]) All() (_ func(yield func(netip.Prefix, V) bool))  { return }
func (*_TABLE_TYPE[V]) All4() (_ func(yield func(netip.Prefix, V) bool)) { return }
func (*_TABLE_TYPE[V]) All6() (_ func(yield func(netip.Prefix, V) bool)) { return }

func (*_TABLE_TYPE[V]) AllSorted() (_ func(yield func(netip.Prefix, V) bool))  { return }
func (*_TABLE_TYPE[V]) AllSorted4() (_ func(yield func(netip.Prefix, V) bool)) { return }
func (*_TABLE_TYPE[V]) AllSorted6() (_ func(yield func(netip.Prefix, V) bool)) { return }

func (*_TABLE_TYPE[V]) Subnets(netip.Prefix) (_ func(yield func(netip.Prefix, V) bool))   { return }
func (*_TABLE_TYPE[V]) Supernets(netip.Prefix) (_ func(yield func(netip.Prefix, V) bool)) { return }
...
func TestTableContainsCompare__TABLE_TYPE(t *testing.T) {
	...
	for rangeIdx := 0; rangeIdx < n; rangeIdx++ {
		ip := random.IP(prng)
...
func TestTableInsertShuffled__TABLE_TYPE(t *testing.T) {
	...
	for rangeIdx := 0; rangeIdx < 10; rangeIdx++ {
...
func TestTableDeleteCompare__TABLE_TYPE(t *testing.T) {
	...
	for rangeIdx := 0; rangeIdx < probes; rangeIdx++ {
...
func TestTableUnionCompare__TABLE_TYPE(t *testing.T) {
	...
	for rangeIdx := 0; rangeIdx < 3; rangeIdx++ {
		pfxs := random.RealWorldPrefixes(prng, n)
...
func TestTableAllSorted__TABLE_TYPE(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			tbl.AllSorted()(func(pfx netip.Prefix, _ int) bool {
			...
			tbl.AllSorted4()(func(pfx netip.Prefix, _ int) bool {
			...
			tbl.AllSorted6()(func(pfx netip.Prefix, _ int) bool {
...
func TestTableSubnets__TABLE_TYPE(t *testing.T) {
	...
	t.Run("empty table", func(t *testing.T) {
		...
		tbl.Subnets(pfx)(func(netip.Prefix, string) bool {
	...
	t.Run("invalid prefix", func(t *testing.T) {
		...
		val := "foo"
		tbl.Insert(pfx, val)
		tbl.Subnets(zeroPfx)(func(netip.Prefix, string) bool {
	...
	t.Run("default gateway", func(t *testing.T) {
		...
		dg4 := mpp("0.0.0.0/0")
		got4 := 0
		tbl.Subnets(dg4)(func(netip.Prefix, int) bool {
			got4++
			return true
		})
		...
		dg6 := mpp("::/0")
		got6 := 0
		tbl.Subnets(dg6)(func(netip.Prefix, int) bool {
			got6++
			return true
		})
...
func TestTableSubnetsCompare__TABLE_TYPE(t *testing.T) {
	...
	for _, pfx := range random.RealWorldPrefixes(prng, n) {
		...
		t.Run("subtest", func(t *testing.T) {
			...
			gotTbl := []netip.Prefix{}
			tbl.Subnets(pfx)(func(pfx netip.Prefix, _ int) bool {
...
func TestTableSupernetsCompare__TABLE_TYPE(t *testing.T) {
	...
	for _, pfx := range random.RealWorldPrefixes(prng, n) {
		...
		t.Run("subtest", func(t *testing.T) {
			...
			tbl.Supernets(pfx)(func(p netip.Prefix, _ int) bool {
