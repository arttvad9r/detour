...
func (n *_NODE_TYPE[V]) AllIndices() (seq2 func(yield func(uint8, V) bool))    { return }
func (n *_NODE_TYPE[V]) AllChildren() (seq2 func(yield func(uint8, any) bool)) { return }
...
func (n *_NODE_TYPE[V]) EqualRec(o *_NODE_TYPE[V]) bool {
	...
	notEqual := false
	n.AllIndices()(func(idx uint8, nVal V) bool {
	...
	n.AllChildren()(func(addr uint8, nKid any) bool {
...
func (n *_NODE_TYPE[V]) Stats() (s StatsT) {
	...
	n.AllChildren()(func(_ uint8, child any) bool {
		switch child.(type) {
		case *_NODE_TYPE[V]:
			s.SubNodes++
...
func (n *_NODE_TYPE[V]) DirectItemsRec(parentIdx uint8, path StridePath, depth int, is4 bool) (directItems []TrieItem[V]) {
	...
	n.AllIndices()(func(idx uint8, val V) bool {
