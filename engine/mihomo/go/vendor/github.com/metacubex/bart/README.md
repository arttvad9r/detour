...
[![Go Reference](https://pkg.go.dev/badge/github.com/metacubex/bart.svg)](https://pkg.go.dev/github.com/metacubex/bart#section-documentation)
[![Mentioned in Awesome Go](https://awesome.re/mentioned-badge-flat.svg)](https://github.com/avelino/awesome-go)
[![CI](https://github.com/metacubex/bart/actions/workflows/go.yml/badge.svg)](https://github.com/metacubex/bart/actions/workflows/go.yml)
...
```go
import "github.com/metacubex/bart"
...
func (t *Table[V]) Subnets(netip.Prefix) func(yield func(netip.Prefix, V) bool)
func (t *Table[V]) Supernets(netip.Prefix) func(yield func(netip.Prefix, V) bool)
...
PASS
ok  	github.com/metacubex/bart	6.647s
```
