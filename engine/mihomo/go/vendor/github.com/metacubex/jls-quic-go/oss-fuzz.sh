...
# fuzz quic-go
cd $GOPATH/src/github.com/metacubex/jls-quic-go/
...
build_native_go_fuzzer github.com/metacubex/jls-quic-go/internal/wire FuzzFrames frame_fuzzer_v2
build_native_go_fuzzer github.com/metacubex/jls-quic-go/internal/wire FuzzTransportParameters transportparameter_fuzzer_v2
build_native_go_fuzzer github.com/metacubex/jls-quic-go/http3 FuzzFrameParser http3_frame_fuzzer
build_native_go_fuzzer github.com/metacubex/jls-quic-go/internal/wire FuzzHeaderParser header_fuzzer_v2
build_native_go_fuzzer github.com/metacubex/jls-quic-go/internal/handshake FuzzHandshake handshake_fuzzer_v2
build_native_go_fuzzer github.com/metacubex/jls-quic-go FuzzFrameSorter frame_sorter_fuzzer
build_native_go_fuzzer github.com/metacubex/jls-quic-go/http3 FuzzHeaderParsing http3_header_parsing_fuzzer
