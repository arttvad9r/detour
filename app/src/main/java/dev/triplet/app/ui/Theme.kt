...
enum class AppTheme(
    ...
    CATPPUCCIN_LATTE(
        ...
        DetourColors(
            ...
            accent = Color(0xFF8738ED),
            onAccent = Color(0xFFFFFFFF),
            accentSoft = Color(0xFF8738ED).copy(alpha = 0.08f),
            ...
            error = Color(0xFFCC0D36),
            errorSoft = Color(0xFFCC0D36).copy(alpha = 0.10f),
        ),
        dark = false,
    ),
    CATPPUCCIN_MOCHA(
        ...
        DetourColors(
            ...
            accentSoft = Color(0xFFCBA6F7).copy(alpha = 0.10f),
    ...
    GRUVBOX_DARK(
        ...
        DetourColors(
            ...
            errorSoft = Color(0xFFFF806D).copy(alpha = 0.12f),
        ),
        dark = true,
    ),
    DRACULA(
        ...
        DetourColors(
            ...
            errorSoft = Color(0xFFFF7A7A).copy(alpha = 0.12f),
        ),
        dark = true,
    );
