        ...
        AppTheme.entries.forEach { t ->
            ...
            Row(
                Modifier.fillMaxWidth().padding(horizontal = 13.dp, vertical = 5.dp)
                    .background(t.scheme.background, RoundedCornerShape(16.dp))
                    .border(
                        2.dp,
                        if (selected) t.scheme.primary
                ...
                Row {
                    listOf(t.scheme.primary, t.statusOn.second, t.statusIdle.second).forEach { c ->
                        Box(Modifier.padding(horizontal = 3.dp).size(18.dp).background(c, CircleShape))
                    }
                }
                Column(Modifier.padding(start = 14.dp).weight(1f)) {
                    Text(
                        t.label, fontSize = 15.sp, fontWeight = FontWeight.Bold,
