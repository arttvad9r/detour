...
import dev.detour.app.vpn.TriVpnService
...
class VpnManifestTest {
    ...
    @Test fun vpnServiceOptsOutOfUnsupportedAlwaysOnMode() {
        ...
        assertFalse(
            serviceInfo.metaData?.getBoolean("android.net.VpnService.SUPPORTS_ALWAYS_ON", true)
                ?: true,
        )
    }
}
